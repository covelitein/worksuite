        ...
        <div class="bg-white rounded b-shadow-4 create-inv">
            ...
            <x-form class="c-inv-form" id="saveReceiptForm" method="PUT">
                ...
                <div class="row px-lg-4 px-md-4 px-3 py-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            <x-forms.label fieldId="receipt_num" :fieldLabel="__('Receipt Number')"
                ...
                <div class="row px-lg-4 px-md-4 px-3 py-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            <x-forms.label fieldId="project_id" :fieldLabel="__('Project ID')"
                                fieldRequired="true"></x-forms.label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            <x-forms.label fieldId="project_name" :fieldLabel="__('Project Name')"
                                fieldRequired="true"></x-forms.label>
                ...
                <div class="row px-lg-4 px-md-4 px-3 py-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            <x-forms.label fieldId="amount_paid" :fieldLabel="__('Amount Paid')"
                                fieldRequired="true"></x-forms.label>
                            <div class="input-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group c-inv-select mb-4">
                            <x-forms.label fieldId="payment_method" :fieldLabel="__('Payment Method')"
                                fieldRequired="true"></x-forms.label>
                            <div class="select-others height-35 rounded">
                                <select class="form-control select-picker" name="payment_method" id="payment_method"
                                    required>
                                    <option value="Cash" @selected($receipt->payment_method == 'Cash')>Cash</option>
                                    <option value="Bank Transfer" @selected($receipt->payment_method == 'Bank Transfer')>Bank
                                        Transfer</option>
                                    <option value="Credit Card" @selected($receipt->payment_method == 'Credit Card')>Credit
                                        Card</option>
                ...
                <div class="row px-lg-4 px-md-4 px-3 py-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            <x-forms.label fieldId="paid_by" :fieldLabel="__('Paid By')"
                                fieldRequired="true"></x-forms.label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            <x-forms.label fieldId="received_by" :fieldLabel="__('Received By')"
                                fieldRequired="true"></x-forms.label>
